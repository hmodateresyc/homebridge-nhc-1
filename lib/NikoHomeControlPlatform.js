...
const NikoHomeControlAction = require('./NikoHomeControlAction');

const ACTION_TYPE_ACTION = 0;
const ACTION_TYPE_LIGHT  = 1;
const ACTION_TYPE_DIMMER = 2;
const ACTION_TYPE_BLIND  = 4;

const ACTION_HANDLERS = {
    [ACTION_TYPE_ACTION]: NikoHomeControlAction,
...
NikoHomeControlPlatform.prototype.run = function() {
    ...
    this.niko.init({
        ...
        timeout: 2000,
        events: true,
        debug: this.config.debug ? this.log : null
    });
