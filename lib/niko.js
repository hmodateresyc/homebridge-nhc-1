...
function request(obj) {
    return new Promise((resolve, reject) => {
        ...
        socket.connect(options.port || 8000, options.ip, () => {
...
function init(opts) {
    options = opts;
    if (opts.events && !eventSocketStarted) {
        eventSocketStarted = true;
        connectEventSocket();
    }
}
...
function executeActions(id, value) {
    return request({ cmd: 'executeactions', id, value1: value });
}
